      ...
      <div style={{ maxWidth: 460, width: "100%" }} onClick={(e) => e.stopPropagation()}>
        <div style={{ background: t.name === "dark" ? "#0a0807" : "#fffdf7", border: `2px solid ${c.color}`, borderRadius: 16, overflow: "hidden", boxShadow: t.shadow }}>
          ...
          <div style={{ padding: "24px 22px" }}>
            <div style={{ fontSize: 10.5, color: c.color, fontFamily: "ui-monospace,monospace", letterSpacing: ".2em", marginBottom: 12 }}>✅ VERIFIED RECORD</div>
            ...
            <div style={{ marginTop: 14, paddingTop: 12, borderTop: `1px solid ${t.line}`, color: t.textSoft, fontSize: 11.5 }}>📅 {rec.date} · 📄 Tamil Nadu Government record</div>
          </div>
        </div>
        <div style={{ display: "flex", gap: 10, marginTop: 14 }}>
          <button onClick={copy} style={{ flex: 1, padding: 13, background: copied ? "#16a34a" : c.color, color: "#fff", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
