        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(210px,1fr))", gap: 12, marginBottom: 14 }}>
          {THESIS.arc.map((s, i) => (
            <div key={s.stage} style={{ position: "relative", background: t.panel, border: `1px solid ${t.line}`, borderRadius: 14, padding: "18px 16px", boxShadow: t.cardShadow }}>
              ...
              <div style={{ fontSize: 11.5, color: t.red, fontWeight: 600, marginTop: 1 }}>{s.who}</div>
          ...
          return (
            <Reveal key={th.title}>
              <div style={{ background: t.panel, border: `1px solid ${t.line}`, borderTop: `3px solid ${accent}`, borderRadius: 14, padding: "20px 20px", height: "100%", boxShadow: t.cardShadow }}>
                ...
                <div style={{ fontSize: 12.5, fontWeight: 700, color: accent, fontFamily: "ui-monospace,monospace" }}>{th.stat}</div>
              </div>
            </Reveal>
          );
        })}
          ...
          return (
            <Reveal key={ev.title}>
              <div style={{ position: "relative", paddingLeft: 30, marginBottom: 16 }}>
                ...
                <div style={{ fontSize: 11, color: accent, fontFamily: "ui-monospace,monospace", letterSpacing: ".08em", fontWeight: 700 }}>{ev.date}</div>
